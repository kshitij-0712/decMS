...
public class UserManagementService {
     ...
     */
    @Transactional
    public User createUser(String userId, String name, String email, String rawPassword,
        ...
        // Guard: duplicate userId if provided
        if (userId != null && !userId.isBlank() && userRepository.findById(userId).isPresent()) {
            throw new IllegalArgumentException(
