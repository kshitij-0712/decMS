...
public class LegalController {
    ...
    @PostMapping("/legal/verify/{evidenceId}")
    ...
    public String submitAccessRequest(
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("successMessage", "Access request submitted: " + record.requestId());
    ...
    @GetMapping("/legal/access/status")
